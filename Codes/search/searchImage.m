...
%SEARCHIMAGE Applys a HOG Character detector to find Characters in the image.
%  This function searches the supplied image for Characters at multiple 
%  scales. 
%
...
%  largest), we are looking for Characters who are small within in the image 
%  (farther from the camera). At the smaller image scales (e.g., 0.20), we 
%  are looking for Characters who appear larger in the image (closer to the 
%  camera).
%
...
%                  were identified as Characters. Each result is a row vector:
